...
def ifIsNote(lineInformations, lineContent):
  if "Sua nota" in lineInformations:
    newLineContent = concat("== NOTA PESSOAL do destaque acima: ", lineContent)
...
# É possível colocar esse While para saltar
# para as linhas que indicam o título do do livro
# Assim, ele só entra nesse bloco de conteúdo se a linha
# for a do livro e não passa de uma por uma
...
jsonFile = open("C:/Users/luiz.sa/Desktop/ExtrairNotasKindle"+cleanTitle+".json", "w")
notesInJson = json.dump(dictFinal, jsonFile)
