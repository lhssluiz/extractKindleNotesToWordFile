...
dictPositionNotes,dictPositionNotesCopy, tempDict = {}, {}, {}
...
dictPositionNotesCopy = dictPositionNotes

#for keys in dictPositionNotesCopy.keys():
#  for keys1 in dictPositionNotes.keys():
#    if keys.contains(keys1):
#      dictPositionNotes.pop(keys1)
